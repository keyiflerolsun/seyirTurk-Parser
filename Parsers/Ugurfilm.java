...
import com.swenauk.mainmenu.GetsPack.GetUgurfilm;
...
public class Ugurfilm extends Parsers {
    public boolean hasShownParts;
    public boolean isAlt;
    public String lang;
    public String mainUrl;
    public String parsed;

    public Ugurfilm(String str, Context context, ExoPlayer exoPlayer) {
        super(str, context, exoPlayer);
        this.lang = "0";
        this.hasShownParts = false;
    }

    @Override // com.swenauk.mainmenu.Parsers.Parsers
    protected void parse(String str) {
        this.isAlt = true;
        new GetUgurfilm(this).execute(str);
    }
    ...
    public void showAlternates(final Map<String, String> map) {
        ...
        if (map.size() > 1) {
            ...
            builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: com.swenauk.mainmenu.Parsers.Ugurfilm.1
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int r4) {
                    Ugurfilm.this.mainUrl = (String) map.get(charSequenceArr[r4]);
                    try {
                        if (!charSequenceArr[0].toString().contains("Part")) {
                            Ugurfilm.this.isAlt = false;
                        }
                    } catch (Exception unused) {
                        Ugurfilm.this.isAlt = false;
                    }
                    if (Ugurfilm.this.mainUrl.contains("m3u8")) {
                        Ugurfilm ugurfilm = Ugurfilm.this;
                        ugurfilm.streamUrl = ugurfilm.mainUrl;
                        Ugurfilm.this.prepareVideo();
                        return;
                    }
                    new GetUgurfilm(Ugurfilm.this).execute(Ugurfilm.this.mainUrl);
                }
            });
                                                                ...
                                                                if (this.mainUrl.contains("dizigom")) {
                                                                    ...
                                                                    if (!this.mainUrl.contains("contentx") && !this.mainUrl.contains("filese") && !this.mainUrl.contains("playru")) {
                                                                        if (this.mainUrl.contains("fullhdfilmizlesene")) {
                                                                            ...
                                                                            loadFilmakinesi();
                                                                        } else if (this.mainUrl.contains("trstx") || this.mainUrl.contains("sobreatsesuyp")) {
                                                                            new Trstx(this.mainUrl, this.calledContext, this.player, null, Core.Language.None);
                                                                        }
                                                                    }
                                                                    loadContentx();
                                                                }
    ...
    protected void showVideo() {
        if (this.streamUrl.contains(".mp4") && !this.streamUrl.contains(".m3u8")) {
            if (this.streamUrl.contains("yandex.ru")) {
                ...
                this.mediaSource = new ProgressiveMediaSource.Factory(new DataSource.Factory() { // from class: com.swenauk.mainmenu.Parsers.Ugurfilm.2
                    ...
                    public DataSource createDataSource() {
                        ...
                        if (Ugurfilm.this.streamUrl.contains("molyusercontent")) {
                            defaultHttpDataSource.setRequestProperty("Referer", Ugurfilm.this.videoUri.getScheme() + "://" + Ugurfilm.this.videoUri.getHost());
                        } else {
                            defaultHttpDataSource.setRequestProperty("Referer", Ugurfilm.this.videoUri.getScheme() + "://" + Ugurfilm.this.videoUri.getHost());
                        }
            ...
            this.mediaSource = new HlsMediaSource.Factory(new DataSource.Factory() { // from class: com.swenauk.mainmenu.Parsers.Ugurfilm.3
                @Override // com.google.android.exoplayer2.upstream.DataSource.Factory
                public DataSource createDataSource() {
                    DefaultHttpDataSource defaultHttpDataSource = new DefaultHttpDataSource("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36");
                    String str = Ugurfilm.this.videoUri.getScheme() + "://" + Ugurfilm.this.videoUri.getHost();
                    if (Ugurfilm.this.streamUrl.contains("molystream")) {
                        str = Ugurfilm.this.videoUri.getScheme() + "://" + Ugurfilm.this.videoUri.getHost();
                    }
    ...
    private void createAlertWItems(String str) {
        ...
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: com.swenauk.mainmenu.Parsers.Ugurfilm.4
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int r4) {
                Ugurfilm.this.showBuffer();
                System.out.println(Ugurfilm.this.streamUrls.get(charSequenceArr[r4]));
                Ugurfilm ugurfilm = Ugurfilm.this;
                ugurfilm.videoUri = Uri.parse(ugurfilm.streamUrls.get(charSequenceArr[r4]));
                DefaultDataSourceFactory defaultDataSourceFactory = new DefaultDataSourceFactory(Ugurfilm.this.calledContext, Util.getUserAgent(Ugurfilm.this.calledContext, "iFrame"));
                Ugurfilm.this.mediaSource = new ProgressiveMediaSource.Factory(defaultDataSourceFactory).createMediaSource(MediaItem.fromUri(Ugurfilm.this.videoUri));
                Ugurfilm.this.playVideo();
            }
        });
        this.alert = builder.create();
        this.alert.show();
    ...
    public void loadFilmakinesi() {
        new Ugurfilm(this.mainUrl, this.calledContext, this.player);
    }
