...
import com.swenauk.mainmenu.GetsPack.GetWFilmizle;
import com.swenauk.seyirturk.R;
import java.util.Map;

/* loaded from: classes3.dex */
public class WFilmizle extends Parsers {
    ...
    public WFilmizle(String str, Context context, ExoPlayer exoPlayer) {
    ...
    protected void parse(String str) {
        ...
        this.mainUrl = "";
        this.oneLinkWonder = "";
        new GetWFilmizle(this).execute(str);
    }
    ...
    public void showAlternates(final Map<String, String> map) {
        if (!((Activity) this.calledContext).isDestroyed()) {
            if (map.size() > 1) {
                ...
                builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: com.swenauk.mainmenu.Parsers.WFilmizle.1
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int r4) {
                        WFilmizle.this.mainUrl = (String) map.get(charSequenceArr[r4]);
                        WFilmizle.this.isAlt = false;
                        new GetWFilmizle(WFilmizle.this).execute(WFilmizle.this.mainUrl);
                    }
                });
                ...
                if (this.oneLinkWonder.contains("closeload")) {
                    ...
                    new GetWFilmizle(this).execute(this.oneLinkWonder);
                }
            }
        }
        this.isAlt = false;
    ...
    protected void showVideo() {
        if (this.streamUrl.contains(".mp4") && !this.streamUrl.contains(".m3u8")) {
            if (this.streamUrl.contains("yandex.ru")) {
                ...
                this.mediaSource = new ProgressiveMediaSource.Factory(new DataSource.Factory() { // from class: com.swenauk.mainmenu.Parsers.WFilmizle.2
                    ...
                    public DataSource createDataSource() {
                        ...
                        if (WFilmizle.this.streamUrl.contains("molyusercontent")) {
                            defaultHttpDataSource.setRequestProperty("Referer", WFilmizle.this.videoUri.getScheme() + "://" + WFilmizle.this.videoUri.getHost());
                        } else {
                            defaultHttpDataSource.setRequestProperty("Referer", WFilmizle.this.videoUri.getScheme() + "://" + WFilmizle.this.videoUri.getHost());
                        }
            ...
            this.mediaSource = new HlsMediaSource.Factory(new DataSource.Factory() { // from class: com.swenauk.mainmenu.Parsers.WFilmizle.3
                @Override // com.google.android.exoplayer2.upstream.DataSource.Factory
                public DataSource createDataSource() {
                    DefaultHttpDataSource defaultHttpDataSource = new DefaultHttpDataSource("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36");
                    String str = WFilmizle.this.videoUri.getScheme() + "://" + WFilmizle.this.videoUri.getHost();
                    if (WFilmizle.this.streamUrl.contains("molystream")) {
                        str = WFilmizle.this.videoUri.getScheme() + "://" + WFilmizle.this.videoUri.getHost();
                    }
    ...
    private void createAlertWItems(String str) {
        ...
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: com.swenauk.mainmenu.Parsers.WFilmizle.4
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int r4) {
                WFilmizle.this.showBuffer();
                System.out.println(WFilmizle.this.streamUrls.get(charSequenceArr[r4]));
                WFilmizle wFilmizle = WFilmizle.this;
                wFilmizle.videoUri = Uri.parse(wFilmizle.streamUrls.get(charSequenceArr[r4]));
                DefaultDataSourceFactory defaultDataSourceFactory = new DefaultDataSourceFactory(WFilmizle.this.calledContext, Util.getUserAgent(WFilmizle.this.calledContext, "iFrame"));
                WFilmizle.this.mediaSource = new ProgressiveMediaSource.Factory(defaultDataSourceFactory).createMediaSource(MediaItem.fromUri(WFilmizle.this.videoUri));
                WFilmizle.this.playVideo();
            }
        });
        this.alert = builder.create();
        this.alert.show();
    ...
    public void loadFilmakinesi() {
        new WFilmizle(this.mainUrl, this.calledContext, this.player);
    }
